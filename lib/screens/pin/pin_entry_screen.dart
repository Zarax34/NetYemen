// lib/screens/pin/pin_entry_screen.dart
...
/// شاشة إدخال الرمز السري — تظهر عند تسجيل الدخول من جهاز جديد.
///
/// يتحقق عبر verify_account_pin. يتعامل مع PIN_LOCKED و «نسيت الرمز؟».
...
class _PinEntryScreenState extends ConsumerState<PinEntryScreen> {
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      ...
      final correct = await service.verifyAccountPin(pin);
