...
///
/// المراحل: إدخال → تأكيد → set_account_pin → تأشير الجهاز كموثوق → MainScreen.
...
class _PinSetupScreenState extends ConsumerState<PinSetupScreen> {
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      ...
      await service.setAccountPin(pin);
          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    _isConfirming ? Icons.verified_user_rounded : Icons.lock_outline_rounded,
                    size: 64,
